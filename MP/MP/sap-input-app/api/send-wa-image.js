...
export default async function handler(req, res) {
  ...
  try {
    ...
    const microlinkUrl = `https://api.microlink.io/?url=${targetUrl}&screenshot=true&meta=false&waitForTimeout=35000&viewport.width=1400&viewport.height=1000&viewport.deviceScaleFactor=2&element=%23excel-report-sheet`;
